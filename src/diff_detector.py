...
from src.collectors.base import InformationItem  # noqa: E402
...
class DiffDetector:
    ...
    def detect_new_items(self, collected_items: List[InformationItem], stored_items: List[Dict]) -> List[InformationItem]:
        """
        新着情報のみを抽出
